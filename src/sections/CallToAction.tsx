  ...
  return (
    <section ref={sectionRef} className="py-20 md:py-24">
      <div className="container">
        ...
        >
          <div
            className="absolute inset-0 bg-[rgb(78,32,138)] bg-blend-overlay [mask-image:radial-gradient(50%_50%_at_50%_35%,black,transparent)] group-hover:opacity-0 opacity-100 transition duration-700"
            style={{ backgroundImage: `url(${gridLines.src})` }}
          ></div>
          <motion.div
            ref={borderedDivRef}
            className="absolute inset-0 bg-[rgb(78,32,138)] bg-blend-overlay opacity-0 group-hover:opacity-100 transition duration-700"
